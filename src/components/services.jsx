    ...
    return (
        <section className={`h-screen flex flex-col items-center justify-center ${darkMode ? "text-coffee" : "text-verge-black"}`}>
            ...
            >
                ...
                <motion.h4 className="sm:px-16 px-6 font-bold lg:text-[32px] md:text-[24px] sm:text-[18px] text-[12px] uppercase" variants={textVariant2}>bachelor, business administration. 2020.</motion.h4>
